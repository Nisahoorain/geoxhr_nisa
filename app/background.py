...
account_sid = 'AC7f2927edba087d926f637a024efc438a'
auth_token = '92399aba73fcb152354fdcad578405de'
# client = Client(account_sid, auth_token)
#
DB_HOST = 'ec2-15-156-80-22.ca-central-1.compute.amazonaws.com'
DB_USER = 'hayat'
...
EMAIL_CREDENTIALS = [
    {'address': 'jobs@i8is.com', 'password': 'Upwork123??'},  # Add more email addresses and passwords here
    {'address': 'jobs@y8hr.com', 'password': 'Infiniti123??'},
]
def fetch_data():
 for email_credentials in EMAIL_CREDENTIALS:
    ...
    try:
        ...
        search_criteria = f'(SINCE 13-Dec-{year} BEFORE {current_date})'
            ...
            try:
                ...
                for filename, payload in pdf_attachments:
                    try:
                        ...
                        has_images = any(
                            '/XObject' in page['/Resources'] and page['/Resources']['/XObject'].get_object() for page in
                            pdf_reader.pages)
                        if has_images:
                        ...
                        with app.app_context():
                            ...
                            if existing_entry is None:
                                ...
                                duplicate_entry = Emails_data.query.filter(
                                    Emails_data.email == email_str,
